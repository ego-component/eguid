...
## 1 Fork 代码
1. 访问 https://github.com/ego-component/eguid
...
```bash
git clone https://github.com/ego-component/eguid.git
cd eguid
git remote add upstream 'git@github.com:<your github username>/eguid.git'
```
...
## 6 提交 PR
访问 https://github.com/ego-component/eguid, 
